...
def main():
    ...
    parser.add_argument("--triplets", type=str, nargs="+",  default="/media/volume/boot-vol-k-project/Fairness_graph/Code/results/HateXplain_merged_triplets_0.7.json")
    parser.add_argument("--nodes_embeddings", type=str,  default="/media/volume/boot-vol-k-project/Fairness_graph/Code/results/HateXplain_nodes_embeddings_0.7.json")
    parser.add_argument("--batch_size", type=int, default=1, help="the batch size")
    parser.add_argument("--which_prompt", type=str, default="graph2shots", help="the prompt to use")
    parser.add_argument("--end_with", type=str, default="0.7", help="the suffix of the output file")

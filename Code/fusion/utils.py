...
LABEL2ID = {"hatespeech": 0, "hate speech": 0, "hate": 0, "offensive": 2, "normal": 1}
...
def majority_label(annotators):
    return Counter(annotators["label"]).most_common(1)[0][0] if annotators["label"] else None
        ...
        case "HateXplain":
            ...
            for ex in train_data:
                ...
                if ex.get("rationales"):
                    ...
                    if label==1: #normal
                        new_ex["label"] = "b"
                        non_toxic_data_list.append(new_ex)
                    else:
                        new_ex["label"] = "a"
                        toxic_data_list.append(new_ex)
                    
            
        
        
            return non_toxic_data_list,toxic_data_list
